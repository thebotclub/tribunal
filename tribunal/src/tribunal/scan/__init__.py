...
``tribunal.checkers`` still imports from here for backward compatibility.

Each checker analyzes files and returns structured Findings. Checkers are
registered by file extension via :func:`register` and run via
:func:`run_checkers`.
"""
